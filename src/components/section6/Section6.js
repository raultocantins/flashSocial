...
export default function Section6() {
  return (
    <section className="section6">
      ...
      <p>
        <strong>IMPULSIONE</strong> SEU CANAL DO <strong>YOUTUBE</strong> E
        REDES SOCIAIS COM A <strong>AGÊNCIA</strong> MAIS COMPLETA DO BRASIL
      
      </p>
      <a href="/painel/signup" >Cadastrar</a>
    </div>
        </div>
        <div className="text-center-section6">
          ...
          <span
            style={{ fontSize: "25px", color: "#6e6e67", fontWeight: "700" }}
          >
          ...
          <span style={{ fontSize: "18px", fontWeight: "500" }}>
            É um processo <strong>totalmente legal </strong>e{" "}
            <strong>100% seguro</strong>. Basta{" "}
            <strong>escolher o pacote</strong> de sua preferência e seguir
            nossas <strong> etapas fáceis de checkout</strong>.
          </span>
        </div>
